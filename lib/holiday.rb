...
def add_new_holiday_with_supplies(holiday_hash, season, holiday_name, supply_array)
  ...
  holiday_hash [:holiday_supplies] = valentines_day_supplies = ["Cupid Cut-Out", "Candy Hearts"],  
  holiday_hash[:fall] = columbus_day_supplies = ["Flags", "Parade Floats", "Italian Food"]
end
